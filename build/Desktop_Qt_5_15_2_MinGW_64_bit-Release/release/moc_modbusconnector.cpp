...
#include <memory>
#include "../../../../../modbusNov12/OnlineMonitor/ModbusManager/modbusconnector.h"
...
QT_MOC_LITERAL(1, 16, 16), // "connectionFailed"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 9) // "ipAddress"

    },
    "ModbusConnector\0connectionFailed\0\0"
    "ipAddress"
};
...
void ModbusConnector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ModbusConnector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->connectionFailed((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ModbusConnector::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModbusConnector::connectionFailed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ModbusConnector::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ModbusConnector.data,
    qt_meta_data_ModbusConnector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ModbusConnector::connectionFailed(const QString & _t1)
{
