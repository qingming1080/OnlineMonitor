        ...
        Rectangle{
            ...
            Item {
                ...
                Text{
                    ...
                    font.pixelSize: 16
                    text: (deviceObj.WelderType !== DeviceInfoEnum.BRANSON_2000XC) ? GlobalLanguageDefine.strPreWeldHeight + "(mm)" : GlobalLanguageDefine.strCollapseDistance + "(mm)"
                    font.family: GlobalSystemDefine.fontBold
                    color: pRgb(171, 206, 213)
                ...
                Text{
                    ...
                    font.pixelSize: 16
                    text: (deviceObj.WelderType !== DeviceInfoEnum.BRANSON_2000XC) ? GlobalLanguageDefine.strPostWeldHeight + "(mm)" : GlobalLanguageDefine.strAbsoluteDistance + "(mm)"
                    font.family: GlobalSystemDefine.fontBold
                    color: pRgb(171, 206, 213)
                    visible: heightOption
                }
